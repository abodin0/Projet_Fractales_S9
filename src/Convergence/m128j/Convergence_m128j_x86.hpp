#ifndef _Convergence_m128j_x86_
#define _Convergence_m128j_x86_
...
class Convergence_m128j_x86 : public Convergence {

public:

  Convergence_m128j_x86();

  Convergence_m128j_x86(ColorMap* _colors, int _max_iters);
