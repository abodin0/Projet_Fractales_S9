#include "Convergence_GPU_multibrot.hpp"
#include "kernel_GPU_multibrot.cuh"
...
Convergence_GPU_multibrot::Convergence_GPU_multibrot() : Convergence("GPU_double_multibrot")
{

}


Convergence_GPU_multibrot::Convergence_GPU_multibrot(ColorMap* _colors, int _max_iters) : Convergence("GPU_double_multibrot")
{
    colors    = _colors;
...
Convergence_GPU_multibrot::~Convergence_GPU_multibrot( ){
     cudaError_t cudaStatus = cudaDeviceReset();
     free(hostTab);
     free(deviceTab);
}

void Convergence_GPU_multibrot::updateImage(const long double _zoom, const long double _offsetX, const long double _offsetY, const int IMAGE_WIDTH, const int IMAGE_HEIGHT, sf::Image& image)
{
    ...
    kernel_updateImage_GPU_multibrot<<<grid, block>>>(zoom, offsetX, offsetY, IMAGE_WIDTH, IMAGE_HEIGHT, deviceTab, max_iters);
