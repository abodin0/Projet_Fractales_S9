#ifndef _Convergence_dp_n_x86_
#define _Convergence_dp_n_x86_
...
class Convergence_dp_n_x86 : public Convergence {

public:

  Convergence_dp_n_x86();

  Convergence_dp_n_x86(ColorMap* _colors, int _max_iters);
