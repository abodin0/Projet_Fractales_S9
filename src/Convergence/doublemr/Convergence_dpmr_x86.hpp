#ifndef _Convergence_dpmr_x86_
#define _Convergence_dpmr_x86_
...
class Convergence_dpmr_x86 : public Convergence {

public:

  Convergence_dpmr_x86();

  Convergence_dpmr_x86(ColorMap* _colors, int _max_iters);
