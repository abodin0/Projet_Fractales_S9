#ifndef _Convergence_m256j_float_x86_
#define _Convergence_m256j_float_x86_
...
class Convergence_m256j_float_x86 : public Convergence {

public:

  Convergence_m256j_float_x86();

  Convergence_m256j_float_x86(ColorMap* _colors, int _max_iters);
