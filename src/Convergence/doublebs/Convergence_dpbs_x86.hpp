#ifndef _Convergence_dpbs_x86_
#define _Convergence_dpbs_x86_
...
class Convergence_dpbs_x86 : public Convergence {

public:

  Convergence_dpbs_x86();

  Convergence_dpbs_x86(ColorMap* _colors, int _max_iters);
