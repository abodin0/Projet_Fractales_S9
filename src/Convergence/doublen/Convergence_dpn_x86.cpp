...
Convergence_dpn_x86::Convergence_dpn_x86(ColorMap* _colors, int _max_iters) : Convergence("DPN")
{
    colors    = _colors;
...
Convergence_dpn_x86::~Convergence_dpn_x86( ){

}


void Convergence_dpn_x86::updateImage(const long double _zoom, const long double _offsetX, const long double _offsetY, const int IMAGE_WIDTH, const int IMAGE_HEIGHT, sf::Image& image)
{
