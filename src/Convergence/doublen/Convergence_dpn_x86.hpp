#ifndef _Convergence_dpn_x86_
#define _Convergence_dpn_x86_
...
class Convergence_dpn_x86 : public Convergence {

public:

  Convergence_dpn_x86();

  Convergence_dpn_x86(ColorMap* _colors, int _max_iters);
