#ifndef _Convergence_dpmme_x86_
#define _Convergence_dpmme_x86_
...
class Convergence_dpmme_x86 : public Convergence {

public:

  Convergence_dpmme_x86();

  Convergence_dpmme_x86(ColorMap* _colors, int _max_iters);
